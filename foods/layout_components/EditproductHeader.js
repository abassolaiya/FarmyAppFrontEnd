...
<div className="foodheader-top" >
    ...
    <Link to="/sell" className="foodheader-top-right-link" >
        ...
        <div className="foodheader-btm" >

        <div className="foodheader-btm" id="main_header_btm_list" >


<Link to="/retail/ourcategory/10/beverage/" className="foodheader-btm-right-link" >
    <GiWineBottle className="foodheader-btm-right-link-ic" /> Beverages
</Link>

<Link to="/retail/ourcategory/4/fruit-vegetable/" className="foodheader-btm-right-link" >
    <GiFruitBowl className="foodheader-btm-right-link-ic" /> Fruits & Vegetables
</Link>

<Link to="/retail/ourcategory/5/grains/" className="foodheader-btm-right-link" >
    <GiWheat className="foodheader-btm-right-link-ic" /> Grains
</Link>

<Link to="/retail/ourcategory/9/meat-poultry/" className="foodheader-btm-right-link" >
    <GiRoastChicken className="foodheader-btm-right-link-ic" /> Meat and Poultry
</Link>

<Link to="/retail/ourcategory/6/oil-and-seasoningy/" className="foodheader-btm-right-link" >
    <RiOilLine className="foodheader-btm-right-link-ic" /> Oil and Seasoning
</Link>

<Link to="/retail/ourcategory/13/packages/" className="foodheader-btm-right-link" >
    <BiPackage className="foodheader-btm-right-link-ic" /> Packages
</Link>

<Link to="/retail/ourcategory/12/pastries/" className="foodheader-btm-right-link" >
    <GiCupcake className="foodheader-btm-right-link-ic" /> Pasteries
</Link>

<Link to="/retail/ourcategory/7/pasta-and-noodles/" className="foodheader-btm-right-link" >
    <GiNoodles className="foodheader-btm-right-link-ic" /> Pasta and Noodles
</Link>                            

<Link to="/retail/ourcategory/8/sea-food/" className="foodheader-btm-right-link" >
    <GiFishCooked className="foodheader-btm-right-link-ic" /> Sea Foods
</Link>

<Link to="/retail/ourcategory/1/solid-food-variety/" className="foodheader-btm-right-link" >
    <GiGrain className="foodheader-btm-right-link-ic" /> Solid Food Variety
</Link>

<Link to="/retail/ourcategory/3/tubers/" className="foodheader-btm-right-link" >
    <GiPotato className="foodheader-btm-right-link-ic" /> Tubers
</Link>

<Link to="/retail/ourcategory/12/others/" className="foodheader-btm-right-link" style={{
   paddingRight:'2rem'
}} >
