...
const SearchRetailProduct = (props) => {
    ...
    useEffect( () => {
        ...
        Axios.get('/myproducts/myproduct/?search=' + Query ).then(
            ...
            if ( Allproduct && !Errorpage && !Loading ) {
                 todisplay = <>
                            ...
                            <div className="pagination-div" >
                                ...
                                { productcount.next ? <Link className="pagination-div-link" to={'/retail/search/query/' + Query + '/1'} > Next page <BsArrowRightShort className="pagination-div-link-ic" /> </Link> : '' }
...
export default SearchRetailProduct;